...
public class RestTermsAndCondController {
	...
	public ResponseEntity<?> getTermAddAction(Principal principal, HttpServletRequest request, @RequestBody ReqTermsAndConds reqTermAndConditions) {
	...
	public ResponseEntity<?> getTermByPublicId(Principal principal, HttpServletRequest request, @PathVariable("id") String pubId) {
	...
	public ResponseEntity<?> getTermUpdateAction(Principal principal, HttpServletRequest request, @RequestBody ReqTermsAndConds reqTermAndConditions) {
		
		String msg = "Terms Data not Set Or not match requerment ";
		
		if(reqTermAndConditions != null) {
			
			if (reqTermAndConditions.getName() != null && reqTermAndConditions.getDiscription() != null && reqTermAndConditions.getPublicId() != null) {
	...
	private void setTermsConds() {
		...
		if (andConditions == null) {
			...
			long size = andConditions.size();
			long count = conditionsServices.getCount();
