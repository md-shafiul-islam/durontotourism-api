...
public class BankAccountMapperImpl implements BankAccountMapper {
	...
	public List<RestBankAccount> getRestBankAccountsOnly(List<BankAccount> accounts) {
		...
		if (accounts != null) {
			...
			for (BankAccount bankAccount : accounts) {
				...
				RestBankAccount restBankAccount = mapBankAccountWitOutAmountOnly(bankAccount);
	...
	public RestBankAccount mapBankAccountWitOutAmountOnly(BankAccount bankAccount) {
		...
		if (bankAccount != null) {
			...
			account.setBranchName(bankAccount.getBranchName());
			account.setCountry(countryMapper.mappCountry(bankAccount.getCountry()));
			account.setWalletEnable(bankAccount.isWalletEnable());
	...
	private RestUpdateInf mapRestUpdateInfo(String publicId) {
		...
		if (publicId != null) {
			...
			BankAccountUpdateInf bankUpdateInf = bankAccountServices.getBankUpdateInfByBankId(publicId);
