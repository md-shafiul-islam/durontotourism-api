...
public class BankServicesImpl implements BankServices {
	...
	public List<BankAccount> getActiveBankAccounts() {
		...
		return bankRepository.getAllBankAccountByActive(true);
	}
	...
	public BankAccount getBankAccountByAccountNumber(String acNo) {
		...
		if (acNo != null) {
			...
			return bankRepository.getBankAccountByAccountNumber(acNo);
		}
	...
	public List<BankAccount> getUpdatePendingBankAccounts() {
		...
		return bankRepository.getAllBankAccountByUpdateReqStatus(true);
	}
	...
	public List<BankAccount> getAllBankByName(String bankName) {
		...
		return bankRepository.getBankAccountBybankNameAndActive(bankName, true);
	}
	...
	public BankAccount getBankAccountByPublicID(String id) {
		...
		if (id != null) {
			...
			if (!id.isEmpty()) {
				...
				Optional<BankAccount> optional = bankRepository.getBankAccountByPublicId(id);
	...
	public boolean isKeyExist(String key) {
		...
		if (key != null) {
			Optional<BankAccount> option = bankRepository.getBankAccountByPublicId(key);
	...
	private BankAccount getBanAccountByPubliidAndActiveStatus(String publicId, boolean active) {
		...
		Optional<BankAccount> optional = bankRepository.getBankAccountByPublicIdAndActive(publicId, active);
